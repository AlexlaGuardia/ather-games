'use client'
// ⚠⚠ PARKED — THIS IS NOT THE MAP THE GAME USES (2026-08-13, Alex: "lets park the old play3d
// version so we dont mistake it again"). The live map is `voxel3d/VoxelMap.tsx`.
//
// This one belongs to the play3d TILE walker (`/shimmer/play3d`, owner-gated), which is a different
// game surface from the voxel world everyone actually plays. It was mistaken for the live map once
// — cloud discovery was built into it and shipped where nobody could see it — which is why this
// notice is at the top of the file rather than in a doc. Two maps, two walkers:
//
//   voxel3d/VoxelMap.tsx  →  THE LIVE MAP. Voxel world, sampled from worldgen, cloud discovery.
//   this file             →  play3d tile walker. Draws its zone whole, no fog, no discovery.
//
// Discovery deliberately does NOT live here any more (`voxel3d/discovery.ts`). If this walker ever
// wants fog, import it rather than growing a second copy — but first ask whether this surface is
// still alive at all, because the answer may be no.
//
// ── original header ───────────────────────────────────────────────────────────────────────────
