...
export const RECIPES: RecipeDef[] = [
  ...
  // chain ends in and the one a tier-1 keeper builds first). RULED 09-15: Mortar = stone, dressed; still =
  // glass on a fired-clay foot; bowl = fired clay, wide and shallow, cold (a bowl, not a lesser cauldron).
  { id: 'grinder', name: 'Mortar', family: 'stone', station: 'crafting_table', mana: 0,
  ...
  { id: 'mixer', name: 'Bowl', station: 'crafting_table', mana: 0,
