...
export const DIALOGUES: Record<string, Dialogue> = {
  ...
  'vetch-prefight': { id: 'vetch-prefight', lines: [], repeatable: false },
  'vetch-defeat': { id: 'vetch-defeat', lines: [], repeatable: false, onComplete: 'vetchDefeated' },
  ...
  'vetch-home': { id: 'vetch-home', lines: [], repeatable: true },
  ...
  'vetch-post-win': { id: 'vetch-post-win', lines: [], repeatable: false, onComplete: 'vetchDefeated' },
