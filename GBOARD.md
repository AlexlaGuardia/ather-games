...
## 🌉 Shimmer voxel3d — **BRIDGES: plank · trestle · viaduct, each shaped by its span** (2026-08-22, world) · *Last touched 2026-08-22 (world, late — span-typed)*
...
2. **Two aesthetic calls, Alex's:** the timber curtain is thick in profile and the arch is subtle at a 26-block span (a steeper arch buys a longer approach, not a taller hump — the 0.5/column ceiling is walkability, not taste); and `RAIL_MIN_WIDTH` leaves deliberate notches in the parapet. **A notch is the visible cost of a mouth you can walk through.**
3. ✅ **DONE — `gloview-village-3` is a viaduct now** (5 piers, 24.8-block bays, level running deck). Remaining span question: whether `trestle` should reach further than 55 blocks, since 63 and 73 are stone today and might read better as timber.
