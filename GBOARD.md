...
> - **⏭️ NEXT:** the region frame loop — spawn foes on patrol, a cast strikes the collar, deflate on free. Every pure half is done and tested; only the wiring is left. Also open: nothing depletes the new bars yet (Hollows drain, which is a slow by canon; the foes' `pressureDps` is the intended source).
