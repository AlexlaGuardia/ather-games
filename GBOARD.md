...
> - **⚠ ONE THING I DID NOT FIX, AND IT IS ALEX'S CALL:** the ground can also rise **mid-session** if a fold grows while the keeper stands on it, which would bury them with no reload involved. Restore is the only choke point covered. Unproven that it is reachable today; worth a look before the grimoire-ledger growth arc ships.
