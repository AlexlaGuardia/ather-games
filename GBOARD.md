...
2. **⚠ STILL READS HEAVY, AND IT IS THE NEXT THING TO FIX: the trestle pier is a solid timber WALL.** It is up to 5 cells wide under a 7-wide deck and 3 blocks along the span, in the same material as the deck — so deck and support merge into one mass instead of reading as a road carried on posts. A timber trestle wants **slender paired posts with gaps you see through**, not a bulkhead. (The viaduct's stone piers escape this because the material differs from the deck.) Not attempted; Alex has called the look twice and the next change should be his direction, not another unprompted iteration.
