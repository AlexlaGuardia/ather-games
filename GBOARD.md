...
## 🌉 Shimmer voxel3d — **BRIDGES: a crossing that knows its own span** (2026-08-22, world) · *Last touched 2026-08-22 (world, late)*
...
**Next:**
1. **ALEX WALKS ONE.** The camera says it reads; nobody has felt the arch underfoot or tested the mouth. `/tp -149 -755` then `/look 257` is the profile view of `moonwell-glade-0`.
...
3. **`gloview-village-3` is a 149-block span with 20 piers** — a viaduct, not a bridge, and a +4 arch is invisible over that length. **Span-typed crossings** (plank / trestle / arch) is the real answer and was deliberately left out of slice 1.
