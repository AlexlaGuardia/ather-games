...
BRIEFS = {
    ...
    # Vault — COHERENCE GUARD (canon vault.md): the runner is LIGHT, never a creature/species. The greying world.
    "vault": "a small formless spark-orb of pure cyan-and-gold light skimming low and fast just above the ground, mid-leap across a dark bottomless void-gap between two broken floating islands of surviving colored ground, a bright horizontal light-trail streaking behind it close to the surface, dim grey colorless husk-lumps and jagged rooted thorn-spikes clinging to the ledges, the world draining to lifeless grey toward the far edges, strong sense of forward horizontal crossing and speed, abstract glowing light only, empty landscape, absolutely no people no person no human no figure no animal no bird no creature",
    # Dewdrop — canon dewbear-maze.md: Dewbear (dew-blue) vs collar-Moglins in a maze; wildbloom snaps the collar.
    "dewdrop": "a round glowing dew-blue bear spirit with a wide chomping mouth moving through a glowing cyan maze of neon light-corridors, small mischievous grey moglin sprites chasing through the passages, scattered tiny dewdrop points of light along the paths, one large bright blooming wildflower glowing amber at the heart of the maze, playful and luminous",
    # Squall — defenseless bullet-hell: a fragile spark reads and weaves the void's telegraphed barrages.
    "squall": "a single tiny fragile mote of bright white-cyan light weaving through a dense storm of glowing violet-purple projectiles sweeping and raining across a dark field, thin telegraph aiming-lines and expanding warning rings foreshadowing the next volley, a narrow safe gap threading through the barrage, tense sense of a defenseless spark surviving an overwhelming curtain of fire",
    # Driftling — food-chain evolution in the cloud-ocean. Element-AGNOSTIC (Rinn-kin apex mapping is a parked Magii gap — no named species).
    "driftling": "a deep dark dreamlike cloud-ocean lit by soft glow, sleek luminous element-colored fish-shaped light-creatures of many sizes drifting at different depths, a small bright hopeful creature of light near a shimmering school of tiny sparks, a much larger looming darker predator-shape gliding in from the shadowed edge, faint drifting motes, a sense of a growing food chain and quiet danger",
