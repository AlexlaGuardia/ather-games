...
const src = args[0]
if (!src) { console.error('usage: bake-flora-model.mts <in.glb> [--out <file.ts>] [--name <camelCase>]'); process.exit(1) }
...
const lines: string[] = []
lines.push(`// GENERATED by \`npm run bake:flora\` from ${src} — DO NOT EDIT BY HAND.`)
lines.push(`//`)
