...
const LEGEND: Record<BiomeId, [number, number, number]> = {
  ...
  shore: [216, 198, 145],
  'garden': [217, 182, 74],
  'moonwell-glade': [188, 208, 232],
  'mycelial-path': [184, 160, 100],
  'spirit-meadow': [151, 214, 122],
  'twilight-thicket': [122, 107, 158],
  'mana-springs': [95, 208, 196],
  'gloview-village': [224, 149, 86],
  'the-outfields': [168, 162, 140],
